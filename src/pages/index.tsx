...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`3PL SKYAAN`}</title>

        <meta
          name="description"
          content="Welcome to 3PL SKYAAN - Your Reliable Partner in Inventory Management. We Pack, Label, and Dispatch Your Shipment to Amazon for FBA Effortlessly and Efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb2dpc3RpY3N8ZW58MHx8fHwxNjk2MzM3NDI0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to 3PL SKYAAN - Your Reliable Partner in Inventory Management. We Pack, Label, and Dispatch Your Shipment to Amazon for FBA Effortlessly and Efficiently.`}
            </Text>
            <Box

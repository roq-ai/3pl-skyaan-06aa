            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Dispatch Date"
                  text={
                    data?.dispatch_date ? format(parseISO(data?.dispatch_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem
                  label="Arrival Date"
                  text={
                    data?.arrival_date ? format(parseISO(data?.arrival_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
